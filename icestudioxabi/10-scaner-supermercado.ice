    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "En ejercicio tenemos un sensor infrarojo, cuando pasa un objeto por el sonara un pitido y mediante el su tic de salida encenderemos una led, aparte tenemos una puerta logica and que sus entradas vienen de la salida del pitido y el latido encendiendo una led.\nPor otra parte la salida del pitido lega a un contador que mandara una señal a un display donde veremos el numero de objetos que pasan por el sensor.\nPor ultimo tenemosun boton para resetear el contador",
            "readonly": true
          },
          "position": {
            "x": 152,
