    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "En este ejercicio tenemos dos botones mediante el primero podemos resetear el contador, mientras que el segundo boton incrementamos el contador,\nGracias al tic de pulsadores que tenemos despues del primer boton resolveremos el problema que podemos tener al mantener pulsado el segundo boton, haciendo asi que el contador solamente se incremente una vez cada vez que pulsamos el boton,\nDespues del cntador tenemos dos leds que se encenderan de forma binaria segun el numero que tenemos en el contador\nmediante el segundo contador(que esta conectado con el primero) mandara una señal al display donde veremos el numero que temos en el contador",
            "readonly": true
          },
          "position": {
            "x": -16,
