    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Mediante un corazon de tics, en este caso de 1segundo(cambiando esto podemos hacer un minutero) conectado a un contador podemos crear un segundero, en este caso contara hasta 9 segundos y despues se reseteara",
            "readonly": true
          },
          "position": {
            "x": -48,
