    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "En este ejercicio tenemos un corazon que hara incrementar nuestro contador, y gracias a la tabla de 14 posicionespodemos almacenar los valores de kla secuencia que queremos hacer, en este ejercicio iremos encendiendo y apagando las leds de uno en uno y vuelta, despues de esto se reseteara el contador iniciando asi el proceso ",
            "readonly": true
          },
          "position": {
            "x": 88,
